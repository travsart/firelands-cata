...
/*static*/ std::string Firelands::Encoding::Base32::Encode(std::vector<uint8> const& data)
{
    return Firelands::Impl::GenericBaseEncoding<B32Impl>::Encode(data);
}

/*static*/ Optional<std::vector<uint8>> Firelands::Encoding::Base32::Decode(std::string const& data)
{
    return Firelands::Impl::GenericBaseEncoding<B32Impl>::Decode(data);
}
