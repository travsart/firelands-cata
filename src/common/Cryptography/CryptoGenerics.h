...
namespace Firelands::Impl
{
    struct CryptoGenericsImpl
    {
        ...
        static typename Cipher::IV GenerateRandomIV()
        {
            ...
            Firelands::Crypto::GetRandomBytes(iv);
            return iv;
        }
...
namespace Firelands::Crypto
{
    ...
    void AEEncryptWithRandomIV(std::vector<uint8>& data, typename Cipher::Key const& key)
    {
        ...
        // select random IV
        IV iv = Firelands::Impl::CryptoGenericsImpl::GenerateRandomIV<Cipher>();
        Tag tag;
        ...
        Firelands::Impl::CryptoGenericsImpl::AppendToBack(data, iv);
        Firelands::Impl::CryptoGenericsImpl::AppendToBack(data, tag);
    }
    ...
    bool AEDecrypt(std::vector<uint8>& data, typename Cipher::Key const& key)
    {
        ...
        IV iv;
        Tag tag;
        Firelands::Impl::CryptoGenericsImpl::SplitFromBack(data, tag);
        Firelands::Impl::CryptoGenericsImpl::SplitFromBack(data, iv);
