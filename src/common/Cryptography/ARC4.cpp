...
Firelands::Crypto::ARC4::ARC4() : _ctx(EVP_CIPHER_CTX_new())
{
...
Firelands::Crypto::ARC4::~ARC4()
{
    EVP_CIPHER_CTX_free(_ctx);
    EVP_CIPHER_free(_cipher);
}

void Firelands::Crypto::ARC4::Init(uint8 const* seed, std::size_t len)
{
...
void Firelands::Crypto::ARC4::UpdateData(uint8* data, std::size_t len)
{
    int outlen = 0;
