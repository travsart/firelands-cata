...
constexpr std::size_t Firelands::Crypto::TOTP::RECOMMENDED_SECRET_LENGTH;
static constexpr uint32 TOTP_INTERVAL = 30;
static constexpr uint32 HMAC_RESULT_SIZE = 20;

/*static*/ uint32 Firelands::Crypto::TOTP::GenerateToken(Secret const& secret, time_t timestamp)
{
...
/*static*/ bool Firelands::Crypto::TOTP::ValidateToken(Secret const& secret, uint32 token)
{
