...
class FC_COMMON_API GameObjectModelOwnerBase
{
public:
...
class FC_COMMON_API GameObjectModel /*, public Intersectable*/
{
...
FC_COMMON_API void LoadGameObjectModelList(std::string const& dataPath);
