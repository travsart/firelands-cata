    ...
    public:
        ...
        */
        ...
        void PExecute(Format&& sql, Args&&... args)
        {
            ...
            Execute(Firelands::StringFormat(std::forward<Format>(sql), std::forward<Args>(args)...).c_str());
        }
        ...
        */
        ...
        void DirectPExecute(Format&& sql, Args&&... args)
        {
            ...
            DirectExecute(Firelands::StringFormat(std::forward<Format>(sql), std::forward<Args>(args)...).c_str());
        }
        ...
        */
        ...
        QueryResult PQuery(Format&& sql, T* conn, Args&&... args)
        {
            ...
            return Query(Firelands::StringFormat(std::forward<Format>(sql), std::forward<Args>(args)...).c_str(), conn);
        }
        ...
        QueryResult PQuery(Format&& sql, Args&&... args)
        {
            ...
            return Query(Firelands::StringFormat(std::forward<Format>(sql), std::forward<Args>(args)...).c_str());
        }
