...
class spell_teron_gorefiend_shadow_of_death : public AuraScript
{
    ...
    {
        OnEffectAbsorb.Register(&spell_teron_gorefiend_shadow_of_death::Absorb, EFFECT_0);
        AfterEffectRemove.Register(&spell_teron_gorefiend_shadow_of_death::OnRemove, EFFECT_1, SPELL_AURA_OVERRIDE_CLASS_SCRIPTS, AURA_EFFECT_HANDLE_REAL);
    }
};
...
class spell_teron_gorefiend_spiritual_vengeance : public AuraScript
{
    ...
    void Register() override
    {
        AfterEffectRemove.Register(&spell_teron_gorefiend_spiritual_vengeance::OnRemove, EFFECT_0, SPELL_AURA_MOD_POSSESS, AURA_EFFECT_HANDLE_REAL);
    }
};
...
class spell_teron_gorefiend_shadow_of_death_remove : public SpellScript
{
    ...
    void Register() override
    {
        OnHit.Register(&spell_teron_gorefiend_shadow_of_death_remove::RemoveAuras);
    }
};
