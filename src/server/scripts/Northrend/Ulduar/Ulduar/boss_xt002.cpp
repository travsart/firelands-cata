  ...
  public:
    ...
    struct npc_life_sparkAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* /*who*/) override
        {
            ...
            _scheduler.Schedule(Seconds(12),
                [this](TaskContext spellShock)
                {
            ...
            if (Unit* caster = GetCaster())
            {
                if (InstanceScript* instance = caster->GetInstanceScript())
                {
                    if (Unit* toyPile = ObjectAccessor::GetUnit(*caster, instance->GetGuidData(DATA_TOY_PILE_0 + urand(0, 3))))
                    {
                        ...
                        uint32 const spells[] = {SPELL_RECHARGE_SCRAPBOT, SPELL_RECHARGE_SCRAPBOT, SPELL_RECHARGE_SCRAPBOT, SPELL_RECHARGE_PUMMELER, SPELL_RECHARGE_BOOMBOT};
