...
uint32 const IllusionSpells[MAX_ILLUSION_ROOMS]{SPELL_TELEPORT_TO_CHAMBER_ILLUSION, SPELL_TELEPORT_TO_ICECROWN_ILLUSION, SPELL_TELEPORT_TO_STORMWIND_ILLUSION};

class StartAttackEvent : public BasicEvent
{
  public:
    StartAttackEvent(Creature* summoner, Creature* owner) : _summonerGuid(summoner->GetGUID()), _owner(owner)
    {
    }
  ...
  public:
    ...
    struct boss_voice_of_yogg_saronAI : public BossAI
    {
        ...
        void Reset() override
        {
            ...
            clouds.sort(Firelands::ObjectDistanceOrderPred(me, true));
  ...
  public:
    ...
    struct npc_ominous_cloudAI : public PassiveAI
    {
        ...
        void DoAction(int32 action) override
        {
            ...
            me->GetMotionMaster()->MoveCirclePath(YoggSaronSpawnPos.GetPositionX(), YoggSaronSpawnPos.GetPositionY(), me->GetPositionZ() + 5.0f,
                me->GetDistance2d(YoggSaronSpawnPos.GetPositionX(), YoggSaronSpawnPos.GetPositionY()), clockwise, 16);
        }
