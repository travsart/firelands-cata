...
class boss_deathbringer_saurfang : public CreatureScript
{
  public:
    ...
    struct boss_deathbringer_saurfangAI : public BossAI
    {
        ...
        void SummonedCreatureDies(Creature* summon, Unit* /*killer*/) override { summons.Despawn(summon); }
    ...
    CreatureAI* GetAI(Creature* creature) const override { return GetIcecrownCitadelAI<boss_deathbringer_saurfangAI>(creature); }
};
...
class npc_high_overlord_saurfang_icc : public CreatureScript
{
  public:
    ...
    struct npc_high_overlord_saurfangAI : public ScriptedAI
    {
        ...
        void DoAction(int32 action) override
        {
            ...
            case ACTION_START_EVENT:
            {
                ...
                guardList.sort(Firelands::ObjectDistanceOrderPred(me));
                uint32 x = 1;
            ...
            case ACTION_START_OUTRO:
            {
                ...
                GuardBroadcast([](Creature* guard) { guard->AI()->DoAction(ACTION_DESPAWN); });
                break;
            }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = _events.ExecuteEvent())
            {
                ...
                case EVENT_INTRO_HORDE_8:
                    ...
                    GuardBroadcast([](Creature* guard) { guard->AI()->DoAction(ACTION_CHARGE); });
    ...
    CreatureAI* GetAI(Creature* creature) const override { return GetIcecrownCitadelAI<npc_high_overlord_saurfangAI>(creature); }
};
...
class npc_muradin_bronzebeard_icc : public CreatureScript
{
  public:
    ...
    {
        npc_muradin_bronzebeard_iccAI(Creature* creature) : ScriptedAI(creature) { _instance = me->GetInstanceScript(); }
    ...
    CreatureAI* GetAI(Creature* creature) const override { return GetIcecrownCitadelAI<npc_muradin_bronzebeard_iccAI>(creature); }
};
...
class npc_saurfang_event : public CreatureScript
{
  public:
    ...
    {
        npc_saurfang_eventAI(Creature* creature) : ScriptedAI(creature) { _index = 0; }
    ...
    CreatureAI* GetAI(Creature* creature) const override { return GetIcecrownCitadelAI<npc_saurfang_eventAI>(creature); }
};
...
class spell_deathbringer_blood_link : public SpellScriptLoader
{
  public:
    ...
    {
        bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_BLOOD_LINK_POWER, SPELL_BLOOD_POWER}); }
        ...
        void Register() override { OnEffectHitTarget.Register(&spell_deathbringer_blood_link_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY); }
    };

    SpellScript* GetSpellScript() const override { return new spell_deathbringer_blood_link_SpellScript(); }
};
...
class spell_deathbringer_blood_link_aura : public SpellScriptLoader
{
  public:
    ...
    {
        bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_MARK_OF_THE_FALLEN_CHAMPION}); }
        ...
        void Register() override { OnEffectPeriodic.Register(&spell_deathbringer_blood_link_AuraScript::HandlePeriodicTick, EFFECT_1, SPELL_AURA_PERIODIC_DUMMY); }
    };

    AuraScript* GetAuraScript() const override { return new spell_deathbringer_blood_link_AuraScript(); }
};
...
class spell_deathbringer_blood_power : public SpellScriptLoader
{
  public:
    ...
    class spell_deathbringer_blood_power_SpellScript : public SpellScript
    {
        ...
        void Register() override { AfterHit.Register(&spell_deathbringer_blood_power_SpellScript::ModAuraValue); }
    };
    ...
    SpellScript* GetSpellScript() const override { return new spell_deathbringer_blood_power_SpellScript(); }

    AuraScript* GetAuraScript() const override { return new spell_deathbringer_blood_power_AuraScript(); }
};
...
class spell_deathbringer_rune_of_blood : public SpellScriptLoader
{
  public:
    ...
    {
        bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_BLOOD_LINK_DUMMY}); }
        ...
        void Register() override { OnEffectHitTarget.Register(&spell_deathbringer_rune_of_blood_SpellScript::HandleScript, EFFECT_1, SPELL_EFFECT_SCRIPT_EFFECT); }
    };

    SpellScript* GetSpellScript() const override { return new spell_deathbringer_rune_of_blood_SpellScript(); }
};
...
class spell_deathbringer_blood_beast_blood_link : public SpellScriptLoader
{
  public:
    ...
    class spell_deathbringer_blood_beast_blood_link_AuraScript : public AuraScript
    {
        ...
        void Register() override { OnEffectProc.Register(&spell_deathbringer_blood_beast_blood_link_AuraScript::HandleProc, EFFECT_0, SPELL_AURA_PROC_TRIGGER_SPELL); }
    };

    AuraScript* GetAuraScript() const override { return new spell_deathbringer_blood_beast_blood_link_AuraScript(); }
};
...
class spell_deathbringer_blood_nova : public SpellScriptLoader
{
  public:
    ...
    class spell_deathbringer_blood_nova_SpellScript : public SpellScript
    {
        ...
        void Register() override { OnEffectHitTarget.Register(&spell_deathbringer_blood_nova_SpellScript::HandleScript, EFFECT_1, SPELL_EFFECT_SCRIPT_EFFECT); }
    };

    SpellScript* GetSpellScript() const override { return new spell_deathbringer_blood_nova_SpellScript(); }
};
...
class spell_deathbringer_blood_nova_targeting : public SpellScriptLoader
{
  public:
    ...
    class spell_deathbringer_blood_nova_targeting_SpellScript : public SpellScript
    {
        ...
        void HandleForceCast(SpellEffIndex /*effIndex*/) { GetCaster()->CastSpell(GetHitUnit(), uint32(GetEffectValue()), TRIGGERED_FULL_MASK); }
    ...
    SpellScript* GetSpellScript() const override { return new spell_deathbringer_blood_nova_targeting_SpellScript(); }
};
...
class spell_deathbringer_boiling_blood : public SpellScriptLoader
{
  public:
    ...
    class spell_deathbringer_boiling_blood_SpellScript : public SpellScript
    {
        ...
        void Register() override { OnObjectAreaTargetSelect.Register(&spell_deathbringer_boiling_blood_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY); }
    };
...
class spell_deathbringer_remove_marks : public SpellScriptLoader
{
  public:
    ...
    class spell_deathbringer_remove_marks_SpellScript : public SpellScript
    {
        ...
        void Register() override { OnEffectHitTarget.Register(&spell_deathbringer_remove_marks_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT); }
    };

    SpellScript* GetSpellScript() const override { return new spell_deathbringer_remove_marks_SpellScript(); }
};
