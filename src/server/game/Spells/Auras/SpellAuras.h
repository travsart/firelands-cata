...
class FC_GAME_API AuraApplication
{
  ...
  public:
    ...
    EnumFlag<AuraRemoveMode> GetRemoveMode() const { return _removeMode; }
...
class FC_GAME_API Aura
{
  ...
  public:
    ...
    static Aura* TryCreate(SpellInfo const* spellproto, uint8 effMask, WorldObject* owner, Unit* caster, int32* baseAmount = nullptr, Item* castItem = nullptr,
        ObjectGuid casterGUID = ObjectGuid::Empty, ObjectGuid itemGUID = ObjectGuid::Empty);
    static Aura* Create(
        SpellInfo const* spellproto, uint8 effMask, WorldObject* owner, Unit* caster, int32* baseAmount, Item* castItem, ObjectGuid casterGUID, ObjectGuid itemGUID = ObjectGuid::Empty);
    ...
    bool DropCharge(AuraRemoveMode removeMode = AuraRemoveMode::ByDefault) { return ModCharges(-1, removeMode); }
    ...
    template <class Script> Script* GetScript(std::string const& scriptName) const { return dynamic_cast<Script*>(GetScriptByName(scriptName)); }
...
class FC_GAME_API ChargeDropEvent : public BasicEvent
{
    friend class Aura;
