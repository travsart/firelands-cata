...
class FC_GAME_API AuraApplication
{
  ...
  public:
    ...
    {
        return _flags & (AFLAG_EFF_INDEX_0 | AFLAG_EFF_INDEX_1 | AFLAG_EFF_INDEX_2);
    }
    ...
    {
        return (_flags & AFLAG_POSITIVE) != 0;
    }
    bool IsSelfcast() const
    {
        return (_flags & AFLAG_CASTER) != 0;
    }
...
class FC_GAME_API Aura
{
  ...
  public:
    ...
    int32_t GetRolledOverDuration() const
    {
        return m_rolledOverDuration;
    }
    ...
    {
        return _casterInfo.ApplyResilience;
    }
    void SetCanApplyResilience(bool val)
    {
        _casterInfo.ApplyResilience = val;
    }
    uint8 GetCasterLevel() const
    {
        return _casterInfo.Level;
    }
    float GetCritChance() const
    {
        return _casterInfo.CritChance;
    }
    void SetCritChance(float val)
    {
        _casterInfo.CritChance = val;
    }
    ...
    {
        return m_isLimitedTarget;
    }
    bool IsLimitedTargetWith(Aura const* aura) const;
    void SetIsLimitedTarget(bool val)
    {
        m_isLimitedTarget = val;
    }
    ...
    {
        return GetEffect(effIndex) != nullptr;
    }
    ...
    {
        return m_isUsingCharges;
    }
    void SetUsingCharges(bool val)
    {
        m_isUsingCharges = val;
    }
