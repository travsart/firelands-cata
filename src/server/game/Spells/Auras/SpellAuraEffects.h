...
class FC_GAME_API AuraEffect
{
  ...
  public:
    ...
    {
        return GetBase()->GetCaster();
    }
    ObjectGuid GetCasterGUID() const
    {
        return GetBase()->GetCasterGUID();
    }
    Aura* GetBase() const
    {
        return m_base;
    ...
    template <typename Container> void GetTargetList(Container& targetContainer) const;
    ...
    int32 GetPeriodic() const
    {
        return m_effectPeriodicTimer;
    }
    ...
    {
        return m_periodicTimer;
    }
    void SetPeriodicTimer(int32 periodicTimer)
    {
        m_periodicTimer = periodicTimer;
    }
    ...
    {
        return m_effectPeriodicTimer ? (GetBase()->GetMaxDuration() / m_effectPeriodicTimer) : 1;
    }
