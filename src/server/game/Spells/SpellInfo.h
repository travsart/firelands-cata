...
enum SpellCustomAttributes
{
    ...
    SPELL_ATTR0_CU_ROLLING_PERIODIC = 0x00000800, // SPELL_ATTR0_CU_IGNORE_EVADE
    ...
    // SPELL_ATTR0_CU_NEEDS_AMMO_DATA               = 0x00080000, Not in 4.3.4
    SPELL_ATTR0_CU_BINARY_SPELL = 0x00100000,
    SPELL_ATTR0_CU_SCHOOLMASK_NORMAL_WITH_MAGIC = 0x00200000, // SPELL_ATTR0_CU_NO_POSITIVE_TAKEN_BONUS
    SPELL_ATTR0_CU_LIQUID_AURA = 0x00400000,                  // SPELL_ATTR0_CU_SINGLE_AURA_STACK
    SPELL_ATTR0_CU_DONT_RESET_PERIODIC_TIMER = 0x00800000,    // SPELL_ATTR0_CU_SCHOOLMASK_NORMAL_WITH_MAGIC
    SPELL_ATTR0_CU_RESET_PERIODIC_TIMER = 0x01000000,         // SPELL_ATTR0_CU_AURA_CANNOT_BE_SAVED
...
class FC_GAME_API SpellImplicitTargetInfo
{
  private:
    Targets _target;
...
class FC_GAME_API SpellEffectInfo
{
  ...
  private:
    struct StaticData
    {
        SpellEffectImplicitTargetTypes ImplicitTargetType; // defines what target can be added to effect target list if there's no
                                                           // valid target type provided for effect
        SpellTargetObjectTypes UsedTargetObjectType;       // defines valid target object type for spell effect
    };
    static StaticData _data[TOTAL_SPELL_EFFECTS];
};

struct FC_GAME_API ImmunityInfo
{
...
struct FC_GAME_API SpellDiminishInfo
{
