...
\*************************************************************************/
template <>
FC_API_EXPORT EnumText EnumUtils<CreatureFlagsExtra>::ToString(CreatureFlagsExtra value)
{
    switch (value)
    {
        ...
        case CREATURE_FLAG_EXTRA_NO_XP_AT_KILL: return { "CREATURE_FLAG_EXTRA_NO_XP_AT_KILL", "CREATURE_FLAG_EXTRA_NO_XP_AT_KILL", "creature kill does not provide XP" };
        ...
        case CREATURE_FLAG_EXTRA_NO_COMBAT: return { "CREATURE_FLAG_EXTRA_NO_COMBAT", "CREATURE_FLAG_EXTRA_NO_COMBAT", "" };
        ...
        case CREATURE_FLAG_EXTRA_IGNORE_ALLASSISTANCE: return { "CREATURE_FLAG_EXTRA_IGNORE_ALLASSISTANCE", "CREATURE_FLAG_EXTRA_IGNORE_ALLASSISTANCE", "Prevents creature from responding to assistance calls" };
...
template <>
FC_API_EXPORT std::size_t EnumUtils<CreatureFlagsExtra>::Count() { return 32; }

template <>
FC_API_EXPORT CreatureFlagsExtra EnumUtils<CreatureFlagsExtra>::FromIndex(std::size_t index)
{
    switch (index)
    {
        ...
        case 26: return CREATURE_FLAG_EXTRA_IGNORE_ALLASSISTANCE;
...
template <>
FC_API_EXPORT std::size_t EnumUtils<CreatureFlagsExtra>::ToIndex(CreatureFlagsExtra value)
{
    switch (value)
    {
        ...
        case CREATURE_FLAG_EXTRA_IGNORE_ALLASSISTANCE: return 26;
